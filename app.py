...
def chat():
    ...
    if status_counter == 0:
        ...
        if status_counter == 2:
            if tag == "redo":
                status_counter -= 1
                reply = "No problem. What is your departure and destination? Please reply in the format of 'from City A to City B'."
                f.write("bot: " + reply + "\n")
                f.close()
                return reply
            else:
        ...
        if status_counter == 3:
            if tag == "redo":
                status_counter -= 1
                reply = "No problem. What date do you want?"
                f.write("bot: " + reply + "\n")
                f.close()
                return reply
            else:
        ...
        if status_counter == 4:
                if tag == "redo":
                    status_counter -= 1
                    reply = "No problem. What is your full name?"
                    f.write("bot: " + reply + "\n")
                    f.close()
                    return reply
                else:
